        ...
        **/
        ...
        createButton: function(x,y,scaleX,scaleY, callback, iconName, visited, win,numberPersonalisation,numberX,numberY) {
            ...
            if(visited || win) {
                ...
                /*
                //COMENTADO PARA VERSÃO ICONES ABERTOS
                if(win){
        ...
        clickButton1: function() {
            this.add.tween(this.world).to({alpha: 0}, this.tweenTime, Phaser.Easing.Linear.None, true).onComplete.add(function() {
                location.href = "../UV"+BasicGame.UV+"AV"+BasicGame.AV+"UD"+BasicGame.UD+"OA01/index.html";
            }, this);
        },
        clickButton2: function() {
            this.add.tween(this.world).to({alpha: 0}, this.tweenTime, Phaser.Easing.Linear.None, true).onComplete.add(function() {
                location.href = "../UV"+BasicGame.UV+"AV"+BasicGame.AV+"UD"+BasicGame.UD+"OA02/index.html";
            }, this);
        },
        clickButton3: function() {
            this.add.tween(this.world).to({alpha: 0}, this.tweenTime, Phaser.Easing.Linear.None, true).onComplete.add(function() {
                location.href = "../UV"+BasicGame.UV+"AV"+BasicGame.AV+"UD"+BasicGame.UD+"OA03/index.html";
            }, this);
        },
        clickButton4: function() {
            this.add.tween(this.world).to({alpha: 0}, this.tweenTime, Phaser.Easing.Linear.None, true).onComplete.add(function() {
                location.href = "../UV"+BasicGame.UV+"AV"+BasicGame.AV+"UD"+BasicGame.UD+"OA04/index.html";
            }, this);
        },
        clickButton5: function() {
            this.add.tween(this.world).to({alpha: 0}, this.tweenTime, Phaser.Easing.Linear.None, true).onComplete.add(function() {
                location.href = "../UV"+BasicGame.UV+"AV"+BasicGame.AV+"UD"+BasicGame.UD+"OA05/index.html";
            }, this);
        },
        clickButton6: function() {
            this.add.tween(this.world).to({alpha: 0}, this.tweenTime, Phaser.Easing.Linear.None, true).onComplete.add(function() {
                location.href = "../UV"+BasicGame.UV+"AV"+BasicGame.AV+"UD"+BasicGame.UD+"OA06/index.html";
            }, this);
        },
        ...
        showAbertura: function() {
            ...
            document.getElementById("video_box").src = "../../../../GLOBAL/player/index.html";
        ...
        createBtVideo: function(liberado) {
           ...
           //liberado = false;
            ...
            if(liberado) {
                BasicGame.OfflineAPI.saveVideo("VC01");
                ...
                var videoCinza = this.add.button(130,this.world.height-43, 'hudMapa', null, this, "btCinematicCinza", "btCinematicCinza", "btCinematicCinza", "btCinematicCinza");
            }
            /*
        ...
        createBtCinematic: function(liberado) {
           ...
           //liberado = false;
            if(liberado) {
                BasicGame.OfflineAPI.saveVideo("VC02");
                BasicGame.OnlineAPI.registrarConclusaoVideo("VC02");
                ...
                var vdFinalCinza = this.add.button(84,this.world.height-65, 'hudMapa', null, this, "vdFinalCinza", "vdFinalCinza", "vdFinalCinza", "vdFinalCinza");
            }
            /*
            mov.animations.play('idle');
            mov.inputEnabled = true;
        ...
        backButtonMap: function() {
            ...
            this.tweens.removeAll();
            this.add.tween(this.world).to({alpha: 0}, this.tweenTime, Phaser.Easing.Linear.None, true).onComplete.add(function() {
                location.href = "../../UV"+BasicGame.UV+"AV"+BasicGame.AV+"MAPA/index.html";
            }, this);
        },

        onGotoUN: function() {
            this.add.tween(this.world).to({alpha: 0}, this.tweenTime, Phaser.Easing.Linear.None, true).onComplete.add(function() {
                location.href = "../../../UV"+BasicGame.UV+"Mapa/index.html";
            }, this);
        },
