...
BasicGame.Game.prototype = {
    ...
    onButtonOver: function(elem) {
        this.add.tween(elem.scale).to({x: 1.03, y: 1.03}, 100, Phaser.Easing.Linear.None, true);
    },
    //fixa
    ...
    showTextoIntro: function() {
        ...
        var exemploIntro = this.add.sprite(520, 415, 'exemploIntro');
            exemploIntro.alpha = 0;
            exemploIntro.anchor.set(0.5, 0.5);

        this.groupIntro.add(tutorialText);
        this.groupIntro.add(tutorialText2);
        this.groupIntro.add(exemploIntro);

        this.createDelayTime(6000, function() {
            this.add.tween(tutorialText).to({alpha:0}, 500, Phaser.Easing.Linear.None, true, 500).onComplete.add(
        ...
        this.createDelayTime( 7000, function() {
            this.add.tween(exemploIntro).to({alpha: 1}, 2000, Phaser.Easing.Linear.None, true);
        });

        this.createDelayTime(this.TEMPO_INTRO, function() {
            this.add.tween(tutorialText2).to({alpha: 0}, 500, Phaser.Easing.Linear.None, true);
            this.add.tween(exemploIntro).to({alpha: 0}, 500, Phaser.Easing.Linear.None, true);
            this.add.tween(this.tutorialPlacar).to({y: -300}, 1000, Phaser.Easing.Linear.None, true, 500).onComplete.add(
                function(){
    ...
    gameOverMacaco: function() {
        ...
        this.add.tween(bg).to({alpha: 1}, 500, Phaser.Easing.Linear.None, true, 7000);
        this.add.tween(animal).to({alpha: 1}, 1000, Phaser.Easing.Linear.None, true, 7500).onComplete.add(function() {
    ...
    initGame: function() {
        this.placar = this.add.sprite( this.world.centerX, -300, 'placar');
        this.placar.anchor.set(0.5,0);
        this.add.tween(this.placar).to({y: -130}, 1000, Phaser.Easing.Linear.None, true, 500).onComplete.add(this.showNextLevel, this);
    },
    ...
    createScene: function() {//finished
        ...
        this.juninhoFixo = this.createAnimation(this.world.centerX+380, 50, 'bumbaFixo', 1,1);
    },
    ...
    showNextLevel: function() {
        ...
        switch(this.currentLevel) {
            case 1:
                this.jogadasAtuais=1;
                this.acertosTotais=1;
                if(!this.isWrong) {
                    this.currentSound = this.sound.play("soundP1");
                }
                this.initLevel1((this.isWrong)?500:4000);
            break;
            case 2:
                this.jogadasAtuais=1;
                this.acertosTotais=1;
                ...
                this.initLevel2((this.isWrong)?500:4000);
            break;
            case 3:
    ...
    showQuestion: function(num) {
        this.imageQuestion = this.add.sprite(this.world.centerX, 55, "pergunta" + num);
    ...
    initLevel1: function(delay) {
        this.itens = ['energia2', 'energia4'];
        this.errados = ['energia7', 'energia9', 'energia10'];

        var _letters = this.createRandomItens(this.errados, 2);
        var item  = this.createRandomItens(this.itens, 1);
        _letters.push(item);
        ...
        this.createDelayTime( delay, function() {
            ...
            this.buttons = [];
            this.buttons.push( this.createButton(this.world.centerX    , 540, _letters[0], (_letters[0] == item), (this.isWrong)?0:100) );
            this.buttons.push( this.createButton(this.world.centerX-220, 540, _letters[1], (_letters[1] == item), (this.isWrong)?0:100) );
            this.buttons.push( this.createButton(this.world.centerX+220, 540, _letters[2], (_letters[2] == item), (this.isWrong)?0:100) );
    ...
    initLevel2: function(delay) {
        this.itens = ['energia9', 'energia10'];
        this.errados = ['energia2', 'energia4', 'energia7'];
        ...
        this.createDelayTime( delay, function() {
            // fixo - criar sistema de botoes dentro do array
            this.buttons = [];
            this.buttons.push( this.createButton(this.world.centerX-50, 540, _letters[0], (_letters[0] == item), (this.isWrong)?0:100) );
            this.buttons.push( this.createButton(this.world.centerX-220, 540, _letters[1], (_letters[1] == item), (this.isWrong)?0:100) );
            this.buttons.push( this.createButton(this.world.centerX+220, 540, _letters[2], (_letters[2] == item), (this.isWrong)?0:100) );
            this.buttons.push( this.createButton(this.world.centerX+220, 540, _letters[3], (_letters[3] == item), (this.isWrong)?0:100) );

            this.buttons[1].x = this.world.centerX-((this.buttons[0].width * 0.5)+this.buttons[1].width +20);
            this.buttons[2].x = this.world.centerX+((this.buttons[0].width * 0.5)+this.buttons[2].width -80);
            this.buttons[3].x = this.world.centerX+((this.buttons[0].width * 0.5)+this.buttons[2].width +50);
        });
    },

    initLevel3: function(delay) {
        this.itens = ['energia9', 'energia10', 'energia2', 'energia4', 'energia7'];
        this.errados = ['energia9', 'energia10', 'energia2', 'energia4', 'energia7'];

        var _letters = this.createRandomItens(this.itens, 5);
        var item  = this.createRandomItens(this.errados, 1);
        _letters.push(item);
        ...
        console.log("Botão 1: "+_letters[0]+" é: "+(_letters[0] == item));
        console.log("Botão 2: "+_letters[1]+" é: "+(_letters[1] == item));
        console.log("Botão 3: "+_letters[2]+" é: "+(_letters[2] == item));
        console.log("Botão 4: "+_letters[3]+" é: "+(_letters[3] == item));
        console.log("Botão 5: "+_letters[4]+" é: "+(_letters[4] == item));
        console.log("Botão 6: "+_letters[5]+" é: "+(_letters[5] == item));

        this.createDelayTime( delay, function() {
            // fixo - criar sistema de botoes dentro do array
            this.buttons = [];
            this.buttons.push( this.createButton(this.world.centerX-220, 540, _letters[0], (_letters[0] == item), (this.isWrong)?0:100) );
            this.buttons.push( this.createButton(this.world.centerX-350, 540, _letters[1], (_letters[1] == item), (this.isWrong)?0:100) );
            this.buttons.push( this.createButton(this.world.centerX-80, 540, _letters[2], (_letters[2] == item), (this.isWrong)?0:100) );
            this.buttons.push( this.createButton(this.world.centerX+310, 540, _letters[3], (_letters[3] == item), (this.isWrong)?0:100) );
            this.buttons.push( this.createButton(this.world.centerX+190, 540, _letters[4], (_letters[4] == item), (this.isWrong)?0:100) );
            this.buttons.push( this.createButton(this.world.centerX+60, 540, _letters[5], (_letters[5] == item), (this.isWrong)?0:100) );
        });
    },
    ...
    clickRightButton: function(target) {
        ...
        if(this.currentLevel == 3 && this.jogadasAtuais==2){
