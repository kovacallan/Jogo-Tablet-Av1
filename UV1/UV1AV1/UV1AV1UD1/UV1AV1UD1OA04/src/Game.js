...
BasicGame.Game.prototype = {
    ...
    gameOverMacaco: function() {
        ...
        this.add.tween(bg).to({alpha: 1}, 500, Phaser.Easing.Linear.None, true, 6500);
        this.add.tween(animal).to({alpha: 1}, 1000, Phaser.Easing.Linear.None, true, 7000).onComplete.add(function() {
    ...
    showCorrectName: function(gotoNext) {
        ...
        var t = this.add.tween(this.correctItem)
                    .to({x:this.world.centerX-340 + this.corrects*160, y: 250}, 1300, Phaser.Easing.Linear.None)
                    .to({y: 310}, 200, Phaser.Easing.Quadratic.In);
        t.start();
    ...
    createScene: function() {//finished
        ...
        this.add.sprite( -22, 0, 'background');
        //var anim = this.createAnimation( 788, 262, 'walter', 1,1);

        var spr = this.add.sprite(788, 262, 'walter');
        spr.animations.add('idle', null, 10, true);
        spr.animations.play('idle');
    ...
    showLiveTutorial: function() {
        ...
        this.buttons = [];
        this.buttons.push( this.createButton(this.world.centerX-120, 160, "revista3", true, 100, false) );
    ...
    initLevel1: function() {
        ...
        this.itens = ["livro1", "livro2", "livro3"];
        this.errados = ["bola", "teclado", "abajur", "pombo"];
        ...
        this.buttons = [];
        this.buttons.push( this.createButton(this.world.centerX-120, 560, _letters[0], this.itens.indexOf(_letters[0])>=0, (this.isWrong)?0:1500) );
        this.buttons.push( this.createButton(this.world.centerX+120, 560, _letters[1], this.itens.indexOf(_letters[1])>=0, (this.isWrong)?0:1500) );
    ...
    initLevel2: function() {
        ...
        this.itens = ["revista1", "revista2", "revista3"];
        this.errados = ["sorvete", "suco", "pao", "adesivo"];
        ...
        // fixo - criar sistema de botoes dentro do array
        this.buttons = [];
        this.buttons.push( this.createButton(this.world.centerX-120, 560, _letters[0], this.itens.indexOf(_letters[0])>=0, (this.isWrong)?0:2000) );
        this.buttons.push( this.createButton(this.world.centerX+120, 560, _letters[1], this.itens.indexOf(_letters[1])>=0, (this.isWrong)?0:2000) );
    ...
    initLevel3: function() {
        ...
        this.itens = ["dvd", "jornal", "poster"];
        this.errados = ["mala", "dado", "camiseta", "tenis", "desenho", "tirinha"];
    ...
    createButton: function( x, y, imagem, right, time, canInteract) {
        ...
        this.add.tween(btn.scale).to({x: 0.7, y: 0.7}, 500, Phaser.Easing.Bounce.Out, true, time).onComplete.add(function() {
            if(_canInteract) {
