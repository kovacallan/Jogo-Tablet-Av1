...
BasicGame.Game.prototype = {
    ...
    showCorrectName: function(gotoNext) {
        ...
        var _extra = (this.correctItem._frame.name.toString() == "medalha")? 35 : 0;
    ...
    initLevel1: function() {
        ...
        this.itens = ["dado", "puzzle", "blocos"];
        this.errados = ["selo", "bola", "retrato", "boneco"];
        ...
        this.buttons = [];
        this.buttons.push( this.createButton(this.world.centerX-120, 540, _letters[0], this.itens.indexOf(_letters[0])>=0, 0) );
        this.buttons.push( this.createButton(this.world.centerX+120, 540, _letters[1], this.itens.indexOf(_letters[1])>=0, 0) );
