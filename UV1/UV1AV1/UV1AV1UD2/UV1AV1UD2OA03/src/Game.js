...
BasicGame.Game.prototype = {
    ...
    gameOverMacaco: function() {
        ...
        this.add.tween(bg).to({alpha: 1}, 500, Phaser.Easing.Linear.None, true, 18500);
        this.add.tween(animal).to({alpha: 1}, 1000, Phaser.Easing.Linear.None, true, 19000).onComplete.add(function() {
